...
%token INT FLOAT ID SEMI COMMA ASSIGNOP RELOP LEXWRONG
...
Dec : VarDec                                    { $$ = createNode("Dec", ENUM_SYN_NOT_NULL, @$.first_line
    ...
    | VarDec ASSIGNOP Exp                       { $$ = createNode("Dec", ENUM_SYN_NOT_NULL, @$.first_line
                                                  , 3, package(3, $1, $2, $3)); }
    | VarDec ASSIGNOP LEXWRONG                  { $$ = createNode("Error", ENUM_SYN_NULL, @$.first_line
                                                  , 0, NULL); }
    | error ASSIGNOP Exp                        { $$ = createNode("Error", ENUM_SYN_NULL, @$.first_line
                                                  , 0, NULL); yyerrok; }
    | error Exp                                 { $$ = createNode("Error", ENUM_SYN_NULL, @$.first_line
                                                  , 0, NULL); yyerrok; }
    ;
